...
logger.info('If no asserts failed then the test has passed!');
...
// Test mongo_storage
var mongo_storage = require('./mongo_storage.js')({mongo_uri: 'mongodb://test:test@ds037145.mongolab.com:37145/slack-bot-test'});
